...
Your myskill quit, leaving behind a mountain of unmaintained docs?<br>
...
>
> 👉 **[titanwings.github.io/my-skill-site](https://titanwings.github.io/my-skill-site/)** · **[💬 Discord](https://discord.gg/aRjmJBdK)**
>
...
> This is still a beta version of myskill.skill — more sources coming soon, stay tuned!
...
git clone https://github.com/titanwings/my-skill .claude/skills/create-myskill
...
```bash
git clone https://github.com/titanwings/my-skill ~/.openclaw/workspace/skills/create-myskill
```
...
Once created, invoke the myskill Skill with `/{slug}`.

### Commands

| Command | Description |
|---------|-------------|
| `/list-myskills` | List all myskill Skills |
| `/{slug}` | Invoke full Skill (Persona + Work) |
| `/{slug}-work` | Work capabilities only |
| `/{slug}-persona` | Persona only |
| `/myskill-rollback {slug} {version}` | Rollback to a previous version |
| `/delete-myskill {slug}` | Delete |
...
myskill.skill ❯ Hold on — what's the impact? You haven't explained the context.
...
myskill.skill ❯ Does the timeline match? That feature touched multiple places,
...
Each myskill Skill has two parts that work together:
...
├── me/           # Generated myskill Skills (gitignored)
├── docs/PRD.md
├── requirements.txt
└── LICENSE
```
...
> **[My.Skill: Automated AI Skill Generation via Expert Knowledge Distillation](myskill_skill.pdf)**
>
> We wrote a paper detailing the system design of myskill.skill — the two-part architecture (Work Skill + Persona), multi-source data collection, Skill generation & evolution mechanisms, and evaluation results in real-world scenarios. Check it out if you're interested!

---

## Star History

<a href="https://www.star-history.com/?repos=titanwings%2Fmy-skill&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/image?repos=titanwings/my-skill&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/image?repos=titanwings/my-skill&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/image?repos=titanwings/my-skill&type=date&legend=top-left" />
 </picture>
</a>
