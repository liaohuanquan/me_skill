...
**Code Review 重点**：
- 你反复提到的 CR 问题（N+1、事务、并发安全...）
- 你的 CR 评论风格（直接/委婉，[block]/[suggest] 分级...）
